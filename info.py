...
BOT_TOKEN = environ.get('BOT_TOKEN', "7031422601:AAGq0GagDpo5sK2cU9lTHnjxqxrLCj__Rpc") #if you are going to bot token here make sure your repo is private..
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '1002197809722').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '6941610925').split()]
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002239099884'))
VERIFY_REQ_CHNL = int(environ.get('VERIFY_REQ_CHNL', '-1002244839279'))
NEW_USER_LOG = int(environ.get('NEW_USER_LOG', '-1002174431863'))
BIN_CHNL = int(environ.get('BIN_CHNL', '-1002227076700'))
