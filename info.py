...
BOT_TOKEN = environ.get('BOT_TOKEN', "7158225681:AAF3Zb_4JpoGa7rbdqBGtUy5apVDI_EM6Gs") #if you are going to bot token here make sure your repo is private..
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002244839279'))
VERIFY_REQ_CHNL = int(environ.get('VERIFY_REQ_CHNL', '-1002244839279'))
NEW_USER_LOG = int(environ.get('NEW_USER_LOG', '-1002244839279'))
