...
BOT_TOKEN = environ.get('BOT_TOKEN', "6958188449:AAEe8N1g5fQTXANOIqXZ7Dd9PggHBF3675E") #if you are going to bot token here make sure your repo is private..
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6435349608').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002169605197').split()]
